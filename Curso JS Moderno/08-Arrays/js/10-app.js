...
const NuevoArreglo  = carrito.forEach( function(producto){  // ahora vamos a interactuar con "producto"
        return `${producto.nombre} - Precio: ${producto.precio}`;

})

const NuevoArreglo2 = carrito.map( function(producto){  // .map crea un nuevo arreglo
